...
// Namespace of TestNameSpace::CAD implemented below
...
namespace TestNameSpace
{
	namespace CAD
	{
		...
		{
			//std::cout << "Point created in constructor:" << ToString() << "\n";
		}
		...
		Point::Point(const Point& p)	//Copy constructor
		{
			...
			//std::cout << "Point created in overload constructor: " << *this << "\n";
		}
		...
		{
			//std::cout << "Point destroyed:" << ToString() << "\n";
		}
