...
namespace TestNameSpace
{
	namespace CAD
	{
		...
		Circle::Circle() : m_centre_point(0.0, 0.0), m_radius(0.0)	 // Default constructor
		{
		...
		{
			std::cout << "Circle created in overload constructor.\n";
		}

		Circle::Circle(const Circle& c) : m_radius(c.m_radius), m_centre_point(c.m_centre_point) //Copy constructor
		{
			std::cout << "Circle created in copy constructor.\n";
		}
		...
		Circle& Circle::operator = (const Circle& source)
		{
			...
			std::cout << "Circle assignment operator: " << *this << "\n";
		...
		{
			stringstream ss;
			ss << "Circle radius: " << m_radius << ", Centre Pointe: " << m_centre_point;
