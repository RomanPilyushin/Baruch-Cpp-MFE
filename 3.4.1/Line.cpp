...
namespace TestNameSpace
{
	namespace CAD
	{
		...
		{
			std::cout << "Line created in overload constructor: " << *this << "\n";
		}

		Line::Line(const Line& l) : m_startpoint(l.m_startpoint), m_endpoint(l.m_endpoint)	//Copy constructor
		{
			std::cout << "Line created in copy constructor: " << *this << "\n";
		}
		...
		Line& Line::operator = (const Line& source)
		{
			...
			std::cout << "Line assignment operator: " << *this << "\n";
		...
		{
			//std::cout << "Line destroyed: " << ToString() << "\n";;
		}
		...
		{
			stringstream ss;
			ss << "Line Start Point: " << m_startpoint << ", Line End Point: " << m_endpoint << endl;
