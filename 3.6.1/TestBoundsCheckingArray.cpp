// TestBoundsCheckingArray.cpp
//
// Objective is to test setting up some exception handling capabilities - specifically, the bounds checking array
// in the array class.
// In this file, there will be new try/catch code blocks to handle the array out of bounds exceptions.
...
using TestNameSpace::Containers::Array;  //Using declaration for using a single class (Array)
...
int main()
{
	...
	// Let's try a rond of testing using the try/catch block
	try
	{
