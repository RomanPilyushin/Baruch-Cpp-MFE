...
//#include "StackEmptyException.h"	// Header file that contains definition for object called StackEmptyException
//#include "StackFullException.h"	// Header file that contains definition for object called StackFullException
...
namespace DevonKaberna
{
	namespace Containers
	{
		...
		Stack<T, size>::Stack() : m_array(Array<T>(size)), m_current(0) {}	 // Default constructor. Initializes array<T> to size based on class template parameter.
