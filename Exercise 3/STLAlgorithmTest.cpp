...
#include "IsSmaller.h"	// Header file that contains definition for object called IsSmaller<t>
...
int main()
{
	...
	std::cout << "Number of elements smaller than " << test_value << " using function object is: " << std::count_if(l.begin(), l.end(), TestNameSpace::FunctionalObjects::IsSmaller<double>(test_value)) << std::endl;
